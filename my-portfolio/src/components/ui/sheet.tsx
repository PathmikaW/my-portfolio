...
function SheetContent({ className, children, side = 'right', title, description, ...props }: SheetContentProps) {
  return (
    <SheetPortal>
      <SheetOverlay />
      <SheetPrimitive.Content
        ...
        {...props}
      >
        {/* Accessibility: Add VisuallyHidden title and description */}
        <VisuallyHidden asChild>
          <div>
            <SheetPrimitive.Title>{title || 'Menu'}</SheetPrimitive.Title>
            <SheetPrimitive.Description>
              {description || 'Navigation menu for the website.'}
            </SheetPrimitive.Description>
          </div>
        </VisuallyHidden>

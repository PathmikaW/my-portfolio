...
export const industryProjects: IndustryProject[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'GenAI subsystem: a local LLM (Google Gemma via Ollama, orchestrated with LangChain-Ollama) supporting content review and translation suite-wide, backed by multilingual BAAI/bge-m3 embeddings (SentenceTransformers) for semantic similarity search, plus a FastText-based pipeline for 176-language identification.',
